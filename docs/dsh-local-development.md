...
- A semantic request uses `drawing_observe`, `drawing_build_context`, `drawing_ground`, `drawing_preview_program`, `drawing_evaluate_preview`, and `drawing_finalize_preview`.
