...
function DrawingSurfaceHost({
  ...
  const subscribeRegistry = reactExports.useCallback(
    (listener) => registry.subscribe(sessionId, listener),
    [registry, sessionId]
  );
  const readElectedId = reactExports.useCallback(
    () => registry.getWorkspaceSnapshot(sessionId).electedId,
    [registry, sessionId]
  );
  const electedId = reactExports.useSyncExternalStore(subscribeRegistry, readElectedId, readElectedId);
  ...
  if (contribution !== null) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ContributionErrorBoundary, { contribution, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
class ContributionErrorBoundary extends reactExports.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "扩展工作区暂时无法渲染。" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => this.setState({ error: null }), children: "重试" })
        ]
      }
    );
  }
...
function createDrawingSurfaceRegistry() {
  ...
  return {
    ...
    getWorkspaceSnapshot(sessionId) {
      ...
      return {
        electedId: ((_a = eligible[0]) == null ? void 0 : _a.contribution.id) ?? null,
        contributionIds
      };
    },
