...
describe('@vectorai/drawing-edit-protocol dependency boundary', () => {
  it('owns the protocol production modules', () => {
  ...
  it('keeps production contracts independent from hosts and UI runtimes', () => {
