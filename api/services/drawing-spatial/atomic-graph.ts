...
function documentSamplingBounds(document: DrawingDocument): Bounds2D {
  const finite = document.geometry.flatMap((node): Bounds2D[] => {
...
function normalizedTolerance(value: number | undefined, bounds: Bounds2D): number {
  if (value !== undefined) {
