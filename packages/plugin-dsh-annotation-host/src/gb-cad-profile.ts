...
const GB_LAYERS = [
  ...
  { name: '7标注缺省层', color: 4, lineType: 'DASHED2', lineWeight: 18 },
...
const gbDimensionStyles = (textStyle: string): DxfDimensionStyle[] => [
  ...
  standardDimensionStyle('GB_ANGULAR', { textStyle, angularDecimalPlaces: 0 }),
...
export const CAXA_COMPATIBLE_DXF_PROFILE: DxfExportProfile = {
  ...
  textStyles: [
    { name: 'Standard', font: 'txt.shx', height: 0, widthFactor: 1, lastHeight: 3.5 },
    { name: '标准', font: '', height: 0, widthFactor: 0.667, lastHeight: 3.5 },
    { name: 'SLDTEXTSTYLE0', font: 'txt.shx', height: 0, widthFactor: 0.75, lastHeight: 3.5 },
    { name: 'SLDTEXTSTYLE1', font: 'txt.shx', height: 0, widthFactor: 0.6864493305940874, lastHeight: 3.5 },
    { name: 'SLDTEXTSTYLE2', font: 'txt.shx', height: 0, widthFactor: 0.6875, lastHeight: 3.5 },
    { name: 'SLDTEXTSTYLE3', font: 'txt.shx', height: 0, widthFactor: 0.75, lastHeight: 3.5 },
    { name: 'PC_TEXTSTYLE', font: 'isocp.shx', height: 0, widthFactor: 0.707, lastHeight: 3.5 },
    { name: 'PC_TEXTSTYLE2', font: 'isocp.shx', height: 0, widthFactor: 0.707, lastHeight: 3.5 },
    { name: 'PC_TEXTSTYLE3', font: 'isocp.shx', height: 0, widthFactor: 0.707, lastHeight: 3.5 },
    { name: 'PC_TEXTSTYLE4', font: 'isocp.shx', height: 0, widthFactor: 0.707, lastHeight: 3.5 },
    { name: 'PC_TEXTSTYLE5', font: 'isocp.shx', height: 0, widthFactor: 0.707, lastHeight: 3.5 },
    { name: 'ZWISOGDT', font: 'isocp.shx', height: 0, widthFactor: 1, lastHeight: 3.5 },
    { name: 'XW', font: 'xw.shx', height: 0, widthFactor: 0.8, lastHeight: 3.5 },
    { name: 'HZ0', font: 'sh.shx', height: 0, widthFactor: 0.75, lastHeight: 3.5 },
  ],
